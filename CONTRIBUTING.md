<head>
  <meta charset="UTF-8">
  <meta name="description" content="Contributing to the AMD ROCm documentation style ruleset">
  <meta name="keywords" content="AMD ROCm documentation style ruleset, contributing, contribute, maintainer, contributor">
</head>

# Contributing to the AMD ROCm documentation style ruleset
...
The ROCm documentation style ruleset uses GitHub to host code, collaborate, and manage
version control. We use pull requests (PRs) for all changes within our
repositories. We use [GitHub issues](https://github.com/ROCm/rocm-docs-style/issues)
to track known issues, such as bugs.

### Issue tracking

Before filing a new issue, search the
[existing issues](https://github.com/ROCm/rocm-docs-style/issues) to
...
repository uses the `develop` branch as the default integration branch.
...
* Target the default branch (the **develop** branch) for integration
